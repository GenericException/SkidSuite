...
| **Bytecode-Viewer** | Bytecode-Viewer is a multi-tool similar to Helios, but with a very messy codebase and uses a GUI powered by Java Swing rather than JavaFX. | [bytecode-viewer](https://github.com/Konloch/bytecode-viewer) |
| **JAD** | JAD is an extremely old compiler written in C++ unable to decompile many modern Java features. | [mirror](http://www.javadecompilers.com/jad) |
| **jadx** | jadx is a dex to Java decompiler capable of also doing simple deobfuscation. | [jadx](https://github.com/skylot/jadx) |
| **JD** | JD is a very fast decompiler capable of producing very legible results on non-obfuscated jars. It does not support many modern Java implementations often causing annoying crashes. | [jd](http://jd.benow.ca/) |

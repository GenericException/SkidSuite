...
public class ActionLoadObfu implements ActionListener
{
    private final FrameMain instance;
    private final JButton parent;
    
    public ActionLoadObfu(final FrameMain instance, final JButton parent) {
    ...
    public void actionPerformed(final ActionEvent arg0) {
        ...
        if (val == 0) {
            this.instance.setObfuscated(fc.getSelectedFile());
        }
    }
}
